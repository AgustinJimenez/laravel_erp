                    ...
                    {!! Form::open(array('route' => ['admin.ventas.facturaventa.index_ajax'],'method' => 'post', 'id' => 'search-form')) !!}
                        <div class="row">
                            ...
                            <div class="col-sm-2 col-xs-2">
                                {!! Form::normalInput('razon_social', 'Cliente:', $errors, old('razon_social'), ['' => ''] ) !!} 
                            </div>
                            ...
                            <div class="col-sm-2 col-xs-2">
                                <table>
                                    <tr>
                                        <td> 
                                            {!! Form::normalInput('fecha_inicio', 'Fecha Inicio:', $errors, old('fecha_inicio'), ['' => ''] ) !!} 
                                        </td>
                                        <td>
                            ...
                            <div class="col-sm-2 col-xs-2">
                                <table>
                                    <tr>
                                        <td> 
                                            {!! Form::normalInput('fecha_fin', 'Fecha Fin:', $errors, old('fecha_fin'), ['' => ''] ) !!} 
                                        </td>
                                        <td>
