...
<!--******************************************reporte_filters.blade.php******************************************-->
                @include('compras::admin.compras.partials.reporte_filters_salario')
<!--******************************************reporte_filters.blade.php******************************************-->
...
<!--**************************factura-fileds.blade.php**************************************************-->
                            @include('compras::admin.compras.partials.reporte-field-salario')
<!--**************************factura-fileds.blade.php**************************************************-->
                        </div>
                    @endforeach
...
<!--***************script-factura-venta.blade.php*****************************************-->
    @include('compras::admin.compras.partials.reporte-script-salario')
 <!--**************script-factura-venta.blade.php*****************************************-->
@stop
