    ...
    <div class="box-header">
        {!! Form::open(['route' => ['admin.compras.compra.reporte_gastos_ajax'], 'method' => 'post', 'id' => 'search-form']) !!}
            ...
            {{--     <div class="col-md-2">
                ...
                {{-- <div class="col-md-2">
                    <br>
                    <a href="{{ route('admin.compras.compra.reporte_xls', ['fecha_inicio' => 'A', 'fecha_fin' => 'B','categoria'=>$categorias]) }}" class="btn btn-flat form-control btn-success" id="excel-button-export">Exportar a Excel</a>
                </div> --}}
