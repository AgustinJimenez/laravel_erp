...
<!--******************************************reporte_filters.blade.php******************************************-->
                @include('compras::admin.compras.partials.categoria-reporte_filters')
<!--******************************************reporte_filters.blade.php******************************************-->
...
<!--**************************factura-fileds.blade.php**************************************************-->
                            @include('compras::admin.compras.partials.categoria-reporte-field')
<!--**************************factura-fileds.blade.php**************************************************-->
                        </div>
                    @endforeach
...
<!--***************script-factura-venta.blade.php*****************************************-->
    @include('compras::admin.compras.partials.categoria-reporte-script')
 <!--**************script-factura-venta.blade.php*****************************************-->
@stop
