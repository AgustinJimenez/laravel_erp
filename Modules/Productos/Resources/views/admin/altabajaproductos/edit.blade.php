...
@section('content-header')
    <h1>
        Editar Alta/Baja de: <label for="">{{ $producto->nombre }}</label>   
    ...
    @endif
        ...
        <li><strong>Stock (Antes):</strong>  {{ $anteriorStock }}</li>
        <li><strong>Stock (Actual):</strong>  {{ $producto->stock }}</li>
...
@section('content')
    {!! Form::open(['route' => ['admin.productos.altabajaproducto.update', $altabajaproducto->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('productos::admin.altabajaproductos.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
