...
@section('content-header')
    <h1>
        Editar Tipo de Cristal/Graduacion
    </h1>
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('cristales::tipocristales.title.edit tipocristales') }}</li>
    </ol>
@stop
...
@section('content')
    {!! Form::open(['route' => ['admin.cristales.tipocristales.update', $tipocristales->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('cristales::admin.tipocristales.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
