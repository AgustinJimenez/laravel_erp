    ...
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                <div id="mensaje-eliminar">DESEA ANULAR EL PAGO? SE GENERARA UN CONTRA-ASIENTO.</div>
            </div>

            
            <div class="modal-footer">
            <a class="btn btn-outline btn-flat" href="{{ route('admin.empleados.pagoempleado.anular_asientos', $pagoempleado->id) }}"> <b> ANULAR </b> </a>
