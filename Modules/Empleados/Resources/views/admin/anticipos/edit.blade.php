...
@section('content')
    {!! Form::open(['route' => ['admin.empleados.anticipos.update', $anticipo->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
            <div class="nav-tabs-custom">
                @include('partials.form-tab-headers')
                <div class="tab-content">
                        @include('empleados::admin.anticipos.partials.anticipo-view-fields')
                   <!--
                    <div class="box-footer">
                        
                        <button type="submit" class="btn btn-primary btn-flat" id="submit" >ACTUALIZAR</button>
