    ...
    <script type="text/javascript">
        ...
        $(function () 
        {
            var table = $('#data-table_1').DataTable(
            {
                ...
                ajax: 
                {
                    url: '{!! route('admin.contabilidad.reportes.estado_resultado_ingresos') !!}',
                    type: "GET",
            ...
            var table = $('#data-table_2').DataTable(
            {
                ...
                ajax: 
                {
                    url: '{!! route('admin.contabilidad.reportes.estado_resultado_egresos') !!}',
                    type: "GET",
                    headers: {'X-CSRF-TOKEN': '{{ csrf_token() }}'},
                    data: function (d) 
                    {
