...
<html lang="en">
	<head>
		...
		@if(isset($query))
		<title> Libro Mayor Artronic</title>
		<center><h2>Libro Mayor Artronic</h2></center>
		@else(isset($balance))
		<title> Balance Artronic</title>
		<center><h2>Balance Artronic</h2></center>
		@endif
							...
							@if($tabla->tiene_hijo)
								<tr valign="bottom">
									...
									<td bgcolor="#ffffff" >
										...
										number_format($tabla->totalEjercicioContable($fecha_inicio, $fecha_fin)->debe, 0, '', '.')}}</b></span></p>
									</td>

									<td bgcolor="#ffffff" >
										<p align="center"><span style="color: #000000;" ><b>{{
										number_format($tabla->totalEjercicioContable($fecha_inicio, $fecha_fin)->haber, 0, '', '.')}}</b></span></p>
									</td>	

									<td bgcolor="#ffffff" >
										<p align="center"><span style="color: #000000;" ><b>{{
										number_format($tabla->totalEjercicioContable($fecha_inicio, $fecha_fin)->saldo, 0, '', '.')}}</b></span></p>
									</td>					
							...
							@else
								<tr valign="bottom">
									...
									<td bgcolor="#ffffff" >
										...
										number_format($tabla->totalEjercicioContable($fecha_inicio, $fecha_fin)->debe, 0, '', '.')}}</span></p>
									</td>

									<td bgcolor="#ffffff" >
										<p align="center"><span style="color: #000000;" >{{
										number_format($tabla->totalEjercicioContable($fecha_inicio, $fecha_fin)->haber, 0, '', '.')}}</span></p>
									</td>	

									<td bgcolor="#ffffff" >
										<p align="center"><span style="color: #000000;" >{{
										number_format($tabla->totalEjercicioContable($fecha_inicio, $fecha_fin)->saldo, 0, '', '.')}}</span></p>
									</td>					
