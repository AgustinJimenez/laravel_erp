...
<!--******************************************reporte_filters.blade.php******************************************-->
                @include('contabilidad::admin.reportes.partials-ingreso_egreso.ingreso_egreso-filters')
<!--******************************************reporte_filters.blade.php******************************************-->
...
<!--**************************factura-fileds.blade.php**************************************************-->
                            ...
                            @include('contabilidad::admin.reportes.partials-ingreso_egreso.ingreso_egreso-field')
<!--**************************factura-fileds.blade.php**************************************************-->
                        </div>
                    @endforeach
