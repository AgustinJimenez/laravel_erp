...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('Editar Cuenta') }}</li>
    </ol>
@stop
...
@section('content')
    {!! Form::open(['route' => ['admin.contabilidad.cuenta.update', $cuenta->id], 'method' => 'put', 'id' => 'edit_form']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('contabilidad::admin.cuentas.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach

                    <div class="box-footer">
                        <button type="submit" class="btn btn-primary btn-flat" id="update">Actualizar</button>
