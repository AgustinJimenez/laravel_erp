...
@section('content-header')
    ...
    <ol class="breadcrumb">
        ...
        <li class="active">{{ trans('Editar Asiento') }}</li>
    </ol>
@stop
...
@section('content')
    {!! Form::open(['route' => ['admin.contabilidad.asiento.update', $asiento->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
                ...
                <div class="tab-content">
                    ...
                    @foreach (LaravelLocalization::getSupportedLocales() as $locale => $language)
                        ...
                        <div class="tab-pane {{ locale() == $locale ? 'active' : '' }}" id="tab_{{ $i }}">
                            @include('contabilidad::admin.asientos.partials.edit-fields', ['lang' => $locale])
                        </div>
                    @endforeach
                    ...
                    <div class="box-footer">
                        ...
                        <button type="submit" id="submit" class="btn btn-primary btn-flat">{{ trans('core::core.button.update') }}</button>
    ...
    <script type="text/javascript">
        $( document ).ready(function() {
            $(document).keypressAction({
                actions: [
                    { key: 'b', route: "{{ route('admin.contabilidad.asiento.index') }}" }
                ]
            });
        });
    </script>
