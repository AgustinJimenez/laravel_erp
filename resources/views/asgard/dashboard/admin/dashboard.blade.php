                ...
                @if(isset($año_ejercicio))
                     <div class="container" id="tourpackages-carousel">
                        <div class="col-sm-12">
                            ...
                            @for($i=0; $i < count($año_ejercicio);$i++)
                                <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                    <div class="thumbnail">
                                        <div class="caption">
                                            <div class='col-lg-12'>
                                                <h3><p>Ejercicio Contable: {{$año_ejercicio[$i]}}</p></h3>
                                            </div>
                                            <?php $id_año=$i;?>
                                            <a href="{{ route('dashboard.ejercicio', ['ejercicios' => $año_ejercicio[$i]]) }}" type="button" class="btn btn-primary btn-xs btn-update btn-add-card">Seleccionar</a>
                                        </div>
                                    </div>
                                </div>
                            @endfor
