...
@section('content')
    {!! Form::open(['route' => ['admin.contabilidad.cuenta.update', $cuenta->id], 'method' => 'put']) !!}
    <div class="row">
        <div class="col-md-12">
